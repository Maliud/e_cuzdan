...
import 'package:e_cuzdan/features/statistics/screen/month_tab.dart';
import 'package:e_cuzdan/features/statistics/screen/week_tab.dart';
import 'package:e_cuzdan/features/statistics/screen/year_tab.dart';
      ...
      body: CustomScrollView(slivers: <Widget>[
        SliverAppBar(
            ...
            bottom: TabBar(
              ...
              tabs: [
                const Tab(text: 'Haftalık'),
                const Tab(text: 'Aylık'),
                const Tab(text: 'Yıllık'),
              ],
